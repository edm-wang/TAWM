...
# python train.py task=pde-burgers multi_dt=true checkpoint=/fs/nexus-scratch/anhu/world-model-checkpoints steps=1500100 save_video=false seed=2

# # 3) Time-Aware model: Euler integrator
python train.py task=pde-burgers multi_dt=true checkpoint=/fs/nexus-scratch/anhu/world-model-checkpoints steps=1500100 save_video=false integrator=euler seed=2